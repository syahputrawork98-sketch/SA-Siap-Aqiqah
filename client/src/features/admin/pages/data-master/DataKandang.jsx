...
import { Search, Plus, Edit, Trash2, Eye, Warehouse, MapPin, User } from "lucide-react";
import { MOCK_PENS } from "../../model/adminDataMasterData";

export default function DataKandang() {
  const [search, setSearch] = useState("");
  const [data] = useState(MOCK_PENS);
  ...
  const stats = [
    { title: "Total Kandang", value: data.length, icon: Warehouse, color: "bg-blue-50 text-blue-600" },
                ...
                {filteredData.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="7" className="px-6 py-12 text-center">
                      <EmptyState message="Tidak ada data kandang yang ditemukan." />
                    </td>
                  </tr>
                )}
              </tbody>
