        ...
        {relevantOrders.length === 0 ? (
          ...
          <div className="grid grid-cols-1 gap-4">
            {relevantOrders.map((order) => {
              ...
              return (
                <PublicCard key={order.id} className="group overflow-hidden bg-white border-purple-50 hover:border-purple-200 transition-all duration-300">
                  <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-3 pt-4 md:pt-0 border-t md:border-t-0 border-gray-50">
                       <Link to={`/mitra-kurir/pesanan/${order.id}`}>
